...
namespace esl {
    ...
    namespace computation {
        ...
        {
        protected:
            //std::unordered_map<identity<agent>, timer<mean>> agent_action_time_;
            ...
            ///         that accounting and storing outputs can be handled after the
            ///         current timestep has completed.
            ///
        ...
        protected:
            ...
            /// \param simulation
            /// \return
            virtual size_t send_messages(std::shared_ptr<simulation::model> simulation);
        };
    }
}  // namespace esl
