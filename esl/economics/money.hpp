...
namespace esl::economics {
    ///
    /// \brief  Money is the abstract idea that a currency is a fungible asset. Money further specialises into intangible
    ///         (cash) and tangible (physical money < commodity money)
    ///
    struct money
    : public asset
    , public fungible
